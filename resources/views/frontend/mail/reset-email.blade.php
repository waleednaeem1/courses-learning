																		...
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="https://colorfulce.vetandtech.com/"><img
                                                                                    src="{{ url('https://colorfulce.vetandtech.com/assets/img/logo/colorful.png') }}"  alt="" style="width:200px; margin-left: 55px; margin-top: 13px;"></a>
																			</td>
																		</tr>
																	</table>
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 302px;">
																								<tr>
																									<td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
																										<a href="#" action="javascript:void();"><img src="{{ url('https://colorfulce.vetandtech.com/assets/icons/img_intro_2.png') }}" width="368" height="296" border="0" alt="" /></a>
																									</td>
																								</tr>
																								<tr>
