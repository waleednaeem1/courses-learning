                                                                                                                    ...
                                                                                                                    <table width="20%" border="0" cellspacing="5" cellpadding="5" style="margin-top: 20px;">
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            color: #ffffff;background-color: #f3189e;">
                                                                                                                                <a href="https://colorfulce.vetandtech.com/course/applyCoach/{{$data['courseSlug']}}/{{$data['coach']->id}}/{{auth()->user()->id}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;">
